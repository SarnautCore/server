...
//go:generate protoc --proto_path=. --go_out=.. --go_opt=module=github.com/SarnautCore/server sarnaut/v1/chat.proto sarnaut/v1/common.proto sarnaut/v1/envelope.proto sarnaut/v1/handshake.proto sarnaut/v1/movement.proto sarnaut/v1/replication.proto

...
CREATE TABLE shard.deferred_script_impacts (
    ...
    scope_kind      text NOT NULL CHECK (scope_kind IN ('activation', 'character', 'spawn')),
...
CREATE INDEX deferred_script_impacts_scope_due_idx
    ON shard.deferred_script_impacts (zone_id, scope_kind, scope_id, due_at_ms, sequence);
